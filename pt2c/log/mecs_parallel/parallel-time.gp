...
plot    data using 1:2 w linesp ls 1 title " 1 processor", \
	    data using 1:3 w linesp ls 2 title " 2 processors", \
	    data using 1:4 w linesp ls 3 title " 4 processors", \
	    data using 1:5 w linesp ls 4 title "8 processors", \
